...
> = GigyaRequest<{
    ...
    /**
     * You can set this parameter to true to have a UID automatically generated by the system for the imported user.
     *
     * You must either pass a UID in the request or have createUID set to true. When passing both a UID and createUID: true, the UID will be used and createUID will be ignored.
     */
    createUID?: boolean;
}>;
